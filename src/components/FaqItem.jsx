  ...
  return (
    <div className="z-2 relative mb-16">
      ...
      >
        ...
        <div
          className={clsx(
            "faq-icon relative flex size-12 items-center justify-center rounded-full shadow-400 border-2 border-s2 transition-all duration-500 group-hover:border-s4",
